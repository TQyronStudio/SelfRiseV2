...
- [ ] 2g. **SPECIAL** (14): `lightning-start`, `seven-wonder`,
...
- [ ] 2h. **Batch-vyhodnocovací smyčka** — nezávisle na jednotlivých
...
- [ ] 3.0 Spusť `monthlyProgressTracker.trackingKeys.test.ts` (16),
...
- [ ] 3a. **Habits šablony** (4) — kompletní průchod
- [ ] 3b. **Journal šablony** (4) — kompletní průchod, včetně Depth Explorer
