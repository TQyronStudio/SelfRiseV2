...
const en: TranslationKeys = {
  ...
  home: {
    ...
    xpMultiplier: {
      ...
      timeRemaining: {
        ...
        hoursOnly: '({{hours}}h remaining)',
        minutesOnly: '({{minutes}}m remaining)',
        secondsOnly: '({{seconds}}s remaining)',
      },
    },
    ...
    recommendationCards: {
      habits: {
        adjustSchedule: {
          ...
          description: '{{habitName}} showing {{completionRate}}% completion. Consider reducing frequency.',
          action: 'Adjust Schedule',
        },
        levelUp: {
          title: 'Level Up',
          description: 'You\'re crushing {{habitName}} at {{completionRate}}%! Ready for a new challenge?',
          action: 'Add Challenge',
        },
        addNewHabit: {
          title: 'Add New Habit',
          description: 'You\'re doing great with existing habits! {{successfulDays}} are your strongest days.',
          action: 'Create Habit',
        },
      },
      journal: {
      ...
      goals: {
        startProgress: {
          ...
          description: '{{goalTitle}} needs attention. Start making some progress!',
          action: 'Log Progress',
        },
        almostThere: {
          title: 'Almost There!',
          description: '{{goalTitle}} is {{progressPercent}}% complete. Push to finish!',
          action: 'Final Push',
        },
        timelineCheck: {
          title: 'Timeline Check',
          description: '{{goalTitle}} may need timeline adjustment. {{daysRemaining}} days remaining.',
    ...
    habitFeedback: {
      ...
      excellentEarlyProgress: {
        ...
        description: '{{completionRate}}% completion! You\'re building a strong foundation.',
      },
      goodEarlyPattern: {
        title: '📈 Good Early Pattern',
        description: '{{completionRate}}% completion. You\'re on the right track!',
      },
      earlyLearningPhase: {
        title: '💪 Early Learning Phase',
        description: '{{completionRate}}% completion. Every step counts in building habits!',
      },
      exceptionalPerformance: {
        title: '⭐ Exceptional Performance',
        description: '{{completionRate}}% completion rate! Your dedication to {{habitName}} is extraordinary.',
      },
      outstandingPerformance: {
        title: '🏆 Outstanding Performance',
        description: '{{completionRate}}% completion with bonus effort. Excellent consistency!',
      },
      strongConsistency: {
        title: '✅ Strong Consistency',
        description: '{{completionRate}}% completion rate. Well done maintaining {{habitName}}!',
      },
      steadyProgress: {
        title: '📊 Steady Progress',
        description: '{{completionRate}}% completion. Consider small adjustments to improve consistency.',
      },
      focusOpportunity: {
        title: '💪 Focus Opportunity',
        description: '{{completionRate}}% completion for {{habitName}}. Try breaking it into smaller steps.',
      },
      progressTracking: {
  ...
  common: {
    ...
    dates: {
      ...
      yesterday: 'Yesterday',
      tomorrow: 'Tomorrow',
      nextDay: 'Next {{dayName}}',
      lastDay: 'Last {{dayName}}',
    },
    modals: {
      errorTitle: 'Error',
  ...
  achievements: {
    ...
    achievementNames: {
      ...
      'loyalty-month-explorer': 'Month Explorer',
      'loyalty-two-month-veteran': 'Two Month Veteran',
      'loyalty-century-user': 'Century User',
      'loyalty-half-year-hero': 'Half Year Hero',
      'loyalty-year-legend': 'Year Legend',
      'loyalty-ultimate-veteran': 'Ultimate Veteran',
      'loyalty-master': 'Loyalty Master',
    },
    ...
    achievementRequirements: {
      ...
      'habit-legend': 'Reach Level 50 "Specialist V" with XP primarily from habit activities',
      'first-journal': 'Write your first gratitude journal entry',
      'deep-thinker': 'Write a journal entry with at least 200 characters',
      'journal-enthusiast': 'Write 100 journal entries',
      'grateful-heart': 'Maintain a 7-day journal writing streak',
      'gratitude-guru': 'Achieve a 30-day journal writing streak',
      'eternal-gratitude': 'Maintain a 100-day journal streak',
      'journal-streaker': 'Achieve a 21-day journal writing streak',
      'bonus-seeker': 'Write 50 bonus journal entries',
      'first-star': 'Earn a star (first bonus entry of the day)',
      'five-stars': 'Earn a star 5 times total',
      ...
      'star-master': 'Earn a star 50 times total',
      'star-champion': 'Earn a star 100 times total',
      'star-legend': 'Earn a star 200 times total',
      'flame-starter': 'Earn a flame 5 times total',
      'flame-accumulator': 'Earn a flame 10 times total',
      'flame-master': 'Earn a flame 25 times total',
      'flame-champion': 'Earn a flame 50 times total',
      'flame-legend': 'Earn a flame 100 times total',
      'crown-achiever': 'Earn a crown 3 times total',
      'crown-collector': 'Earn a crown 5 times total',
      'crown-master': 'Earn a crown 10 times total',
      'crown-champion': 'Earn a crown 25 times total',
      'crown-emperor': 'Earn a crown 50 times total',
      'first-goal': 'Set your first goal',
      'goal-getter': 'Complete your first goal',
      'ambitious': 'Set a goal with value 1000 or more',
      'goal-champion': 'Complete 5 goals',
      'progress-tracker': 'Make progress on goals for 7 consecutive days',
      'mega-dreamer': 'Set a goal with value 1,000,000 or more',
      'achievement-unlocked': 'Complete 10 goals',
      ...
      'lightning-start': 'Create and complete a habit on the same day 3 times',
      ...
      'loyalty-month-explorer': '30 active days total',
      'loyalty-two-month-veteran': '60 active days total',
      'loyalty-century-user': '100 active days total',
      'loyalty-half-year-hero': '183 active days total',
      'loyalty-year-legend': '365 active days total',
      'loyalty-ultimate-veteran': '500 active days total',
      'loyalty-master': '1000 active days total',
    },
    ...
    xp: {
      ...
      xpNotification: {
        ...
        sources_one: {
          ...
          monthlyChallenges: 'monthly challenge',
