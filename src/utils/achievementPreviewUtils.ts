...
const generateHabitProgressHint = (achievement: Achievement, userStats: UserStats, t: TFunction): ProgressHint => {
  switch (achievement.id) {
    case 'first-habit':
      return {
        progressText: userStats.habitsCreated === 0
          ? t('achievements.progressHints.first_habit.progress_incomplete')
          : t('achievements.progressHints.first_habit.progress_complete'),
        progressPercentage: userStats.habitsCreated > 0 ? 100 : 0,
        isCompleted: userStats.habitsCreated > 0,
        requirementText: t('achievements.progressHints.first_habit.requirement'),
        actionHint: t('achievements.progressHints.first_habit.action')
      };
      
    case 'habit-builder':
      const created = Math.min(userStats.habitsCreated, 5);
      return {
        progressText: t('achievements.progressHints.habit_builder.progress', { current: created, target: 5 }),
        progressPercentage: (created / 5) * 100,
        isCompleted: created >= 5,
        requirementText: t('achievements.progressHints.habit_builder.requirement'),
        actionHint: t('achievements.progressHints.habit_builder.action'),
    ...
    case 'century-club':
      ...
      return {
        progressText: t('achievements.progressHints.century_club.progress', { current: completed, target: 100 }),
        progressPercentage: (completed / 100) * 100,
        isCompleted: completed >= 100,
        requirementText: t('achievements.progressHints.century_club.requirement'),
        actionHint: t('achievements.progressHints.century_club.action'),
    ...
    case 'consistency-king':
      ...
      return {
        progressText: t('achievements.progressHints.consistency_king.progress', { current: total, target: 1000 }),
        progressPercentage: (total / 1000) * 100,
        isCompleted: total >= 1000,
        requirementText: t('achievements.progressHints.consistency_king.requirement'),
        actionHint: t('achievements.progressHints.consistency_king.action'),
    ...
    case 'streak-champion':
      ...
      return {
        progressText: t('achievements.progressHints.streak_champion.progress', { current: userStats.longestHabitStreak, target: 21 }),
        progressPercentage: (streak / 21) * 100,
        isCompleted: userStats.longestHabitStreak >= 21,
        requirementText: t('achievements.progressHints.streak_champion.requirement'),
        actionHint: t('achievements.progressHints.streak_champion.action'),
    ...
    case 'century-streak':
      ...
      return {
        progressText: t('achievements.progressHints.century_streak.progress', { current: userStats.longestHabitStreak, target: 75 }),
        progressPercentage: (longStreak / 75) * 100,
        isCompleted: userStats.longestHabitStreak >= 75,
        requirementText: t('achievements.progressHints.century_streak.requirement'),
        actionHint: t('achievements.progressHints.century_streak.action'),
    ...
    case 'multi-tasker':
      ...
      return {
        progressText: t('achievements.progressHints.multi_tasker.progress', { current: userStats.maxHabitsInOneDay, target: 5 }),
        progressPercentage: (maxInDay / 5) * 100,
        isCompleted: userStats.maxHabitsInOneDay >= 5,
        requirementText: t('achievements.progressHints.multi_tasker.requirement'),
        actionHint: t('achievements.progressHints.multi_tasker.action')
      };
    ...
    case 'habit-legend':
      ...
      return {
        progressText: t('achievements.progressHints.habit_legend.progress', {
        ...
        requirementText: t('achievements.progressHints.habit_legend.requirement'),
        actionHint: t('achievements.progressHints.habit_legend.action')
      };
...
const generateJournalProgressHint = (achievement: Achievement, userStats: UserStats, t: TFunction): ProgressHint => {
  switch (achievement.id) {
    case 'first-journal':
      return {
        progressText: userStats.journalEntries === 0
          ? t('achievements.progressHints.first_journal.progress_incomplete')
          : t('achievements.progressHints.first_journal.progress_complete'),
        progressPercentage: userStats.journalEntries > 0 ? 100 : 0,
        isCompleted: userStats.journalEntries > 0,
        requirementText: t('achievements.progressHints.first_journal.requirement'),
        actionHint: t('achievements.progressHints.first_journal.action')
      };
      
    case 'deep-thinker':
      // Synchronous fallback - shows progress as pending async load
      return {
        progressText: t('achievements.progressHints.deep_thinker.progress_checking'),
        progressPercentage: 0,
        isCompleted: false,
        requirementText: t('achievements.progressHints.deep_thinker.requirement'),
        actionHint: t('achievements.progressHints.deep_thinker.action')
      };
      
    case 'journal-enthusiast':
      const entries = Math.min(userStats.totalJournalEntries, 100);
      return {
        progressText: t('achievements.progressHints.journal_enthusiast.progress', { current: entries, target: 100 }),
        progressPercentage: (entries / 100) * 100,
        isCompleted: entries >= 100,
        requirementText: t('achievements.progressHints.journal_enthusiast.requirement'),
        actionHint: t('achievements.progressHints.journal_enthusiast.action'),
    ...
    case 'grateful-heart':
      ...
      return {
        progressText: t('achievements.progressHints.grateful_heart.progress', { current: userStats.currentJournalStreak, target: 7 }),
        progressPercentage: (currentStreak / 7) * 100,
        isCompleted: userStats.currentJournalStreak >= 7,
        requirementText: t('achievements.progressHints.grateful_heart.requirement'),
        actionHint: t('achievements.progressHints.grateful_heart.action'),
    ...
    case 'journal-streaker':
      ...
      return {
        progressText: t('achievements.progressHints.journal_streaker.progress', { current: userStats.longestJournalStreak, target: 21 }),
        progressPercentage: (streak21 / 21) * 100,
        isCompleted: userStats.longestJournalStreak >= 21,
        requirementText: t('achievements.progressHints.journal_streaker.requirement'),
        actionHint: t('achievements.progressHints.journal_streaker.action'),
    ...
    case 'gratitude-guru':
      ...
      return {
        progressText: t('achievements.progressHints.gratitude_guru.progress', { current: userStats.longestJournalStreak, target: 30 }),
        progressPercentage: (streak30 / 30) * 100,
        isCompleted: userStats.longestJournalStreak >= 30,
        requirementText: t('achievements.progressHints.gratitude_guru.requirement'),
        actionHint: t('achievements.progressHints.gratitude_guru.action'),
    ...
    case 'eternal-gratitude':
      ...
      return {
        progressText: t('achievements.progressHints.eternal_gratitude.progress', { current: userStats.longestJournalStreak, target: 100 }),
        progressPercentage: (streak100 / 100) * 100,
        isCompleted: userStats.longestJournalStreak >= 100,
        requirementText: t('achievements.progressHints.eternal_gratitude.requirement'),
        actionHint: t('achievements.progressHints.eternal_gratitude.action'),
    ...
    case 'bonus-seeker':
      ...
      return {
        progressText: t('achievements.progressHints.bonus_seeker.progress', { current: bonusEntries, target: 50 }),
        progressPercentage: (bonusEntries / 50) * 100,
        isCompleted: bonusEntries >= 50,
        requirementText: t('achievements.progressHints.bonus_seeker.requirement'),
        actionHint: t('achievements.progressHints.bonus_seeker.action'),
    ...
    case 'first-star':
      return {
        progressText: userStats.starCount === 0
          ? t('achievements.progressHints.first_star.progress_incomplete')
          : t('achievements.progressHints.first_star.progress_complete'),
        progressPercentage: userStats.starCount > 0 ? 100 : 0,
        isCompleted: userStats.starCount > 0,
        requirementText: t('achievements.progressHints.first_star.requirement'),
        actionHint: t('achievements.progressHints.first_star.action')
      };

    case 'five-stars':
      const stars5 = Math.min(userStats.starCount, 5);
      return {
        progressText: t('achievements.progressHints.five_stars.progress', { current: stars5, target: 5 }),
        progressPercentage: (stars5 / 5) * 100,
        isCompleted: stars5 >= 5,
        requirementText: t('achievements.progressHints.five_stars.requirement'),
        actionHint: t('achievements.progressHints.five_stars.action'),
    ...
    case 'flame-achiever':
      return {
        progressText: userStats.flameCount === 0
          ? t('achievements.progressHints.flame_achiever.progress_incomplete')
          : t('achievements.progressHints.flame_achiever.progress_complete'),
        progressPercentage: userStats.flameCount > 0 ? 100 : 0,
        isCompleted: userStats.flameCount > 0,
        requirementText: t('achievements.progressHints.flame_achiever.requirement'),
        actionHint: t('achievements.progressHints.flame_achiever.action')
      };

    case 'bonus-week':
      const bonusWeek = Math.min(userStats.bonusStreakDays, 7);
      return {
        progressText: t('achievements.progressHints.bonus_week.progress', { current: bonusWeek, target: 7 }),
        progressPercentage: (bonusWeek / 7) * 100,
        isCompleted: bonusWeek >= 7,
        requirementText: t('achievements.progressHints.bonus_week.requirement'),
        actionHint: t('achievements.progressHints.bonus_week.action'),
    ...
    case 'crown-royalty':
      return {
        progressText: userStats.crownCount === 0
          ? t('achievements.progressHints.crown_royalty.progress_incomplete')
          : t('achievements.progressHints.crown_royalty.progress_complete'),
        progressPercentage: userStats.crownCount > 0 ? 100 : 0,
        isCompleted: userStats.crownCount > 0,
        requirementText: t('achievements.progressHints.crown_royalty.requirement'),
    ...
    case 'golden-bonus-streak':
      ...
      return {
        progressText: t('achievements.progressHints.golden_bonus_streak.progress', { current: goldenStreak, target: 7 }),
    ...
    case 'bonus-century':
      ...
      return {
        progressText: t('achievements.progressHints.bonus_century.progress', { current: bonusCentury, target: 200 }),
        progressPercentage: (bonusCentury / 200) * 100,
        isCompleted: bonusCentury >= 200,
        requirementText: t('achievements.progressHints.bonus_century.requirement'),
        actionHint: t('achievements.progressHints.bonus_century.action'),
    ...
    case 'star-beginner':
      ...
      return {
        progressText: t('achievements.progressHints.star_beginner.progress', { current: starBeginner, target: 10 }),
        progressPercentage: (starBeginner / 10) * 100,
        isCompleted: starBeginner >= 10,
        requirementText: t('achievements.progressHints.star_beginner.requirement'),
        actionHint: t('achievements.progressHints.star_beginner.action'),
    ...
    case 'star-collector':
      ...
      return {
        progressText: t('achievements.progressHints.star_collector.progress', { current: starCollector, target: 25 }),
        progressPercentage: (starCollector / 25) * 100,
        isCompleted: starCollector >= 25,
        requirementText: t('achievements.progressHints.star_collector.requirement'),
        actionHint: t('achievements.progressHints.star_collector.action'),
    ...
    case 'star-master':
      ...
      return {
        progressText: t('achievements.progressHints.star_master.progress', { current: starMaster, target: 50 }),
        progressPercentage: (starMaster / 50) * 100,
        isCompleted: starMaster >= 50,
        requirementText: t('achievements.progressHints.star_master.requirement'),
        actionHint: t('achievements.progressHints.star_master.action'),
    ...
    case 'star-champion':
      ...
      return {
        progressText: t('achievements.progressHints.star_champion.progress', { current: starChampion, target: 100 }),
        progressPercentage: (starChampion / 100) * 100,
        isCompleted: starChampion >= 100,
        requirementText: t('achievements.progressHints.star_champion.requirement'),
        actionHint: t('achievements.progressHints.star_champion.action'),
    ...
    case 'star-legend':
      ...
      return {
        progressText: t('achievements.progressHints.star_legend.progress', { current: starLegend, target: 200 }),
        progressPercentage: (starLegend / 200) * 100,
        isCompleted: starLegend >= 200,
        requirementText: t('achievements.progressHints.star_legend.requirement'),
        actionHint: t('achievements.progressHints.star_legend.action'),
    ...
    case 'flame-starter':
      ...
      return {
        progressText: t('achievements.progressHints.flame_starter.progress', { current: flameStarter, target: 5 }),
        progressPercentage: (flameStarter / 5) * 100,
        isCompleted: flameStarter >= 5,
        requirementText: t('achievements.progressHints.flame_starter.requirement'),
        actionHint: t('achievements.progressHints.flame_starter.action'),
    ...
    case 'flame-accumulator':
      ...
      return {
        progressText: t('achievements.progressHints.flame_accumulator.progress', { current: flameAccumulator, target: 10 }),
        progressPercentage: (flameAccumulator / 10) * 100,
        isCompleted: flameAccumulator >= 10,
        requirementText: t('achievements.progressHints.flame_accumulator.requirement'),
        actionHint: t('achievements.progressHints.flame_accumulator.action'),
    ...
    case 'flame-master':
      ...
      return {
        progressText: t('achievements.progressHints.flame_master.progress', { current: flameMaster, target: 25 }),
        progressPercentage: (flameMaster / 25) * 100,
        isCompleted: flameMaster >= 25,
        requirementText: t('achievements.progressHints.flame_master.requirement'),
        actionHint: t('achievements.progressHints.flame_master.action'),
    ...
    case 'flame-champion':
      ...
      return {
        progressText: t('achievements.progressHints.flame_champion.progress', { current: flameChampion, target: 50 }),
        progressPercentage: (flameChampion / 50) * 100,
        isCompleted: flameChampion >= 50,
        requirementText: t('achievements.progressHints.flame_champion.requirement'),
        actionHint: t('achievements.progressHints.flame_champion.action'),
    ...
    case 'flame-legend':
      ...
      return {
        progressText: t('achievements.progressHints.flame_legend.progress', { current: flameLegend, target: 100 }),
        progressPercentage: (flameLegend / 100) * 100,
        isCompleted: flameLegend >= 100,
        requirementText: t('achievements.progressHints.flame_legend.requirement'),
        actionHint: t('achievements.progressHints.flame_legend.action'),
    ...
    case 'crown-achiever':
      ...
      return {
        progressText: t('achievements.progressHints.crown_achiever.progress', { current: crownAchiever, target: 3 }),
        progressPercentage: (crownAchiever / 3) * 100,
        isCompleted: crownAchiever >= 3,
        requirementText: t('achievements.progressHints.crown_achiever.requirement'),
        actionHint: t('achievements.progressHints.crown_achiever.action'),
    ...
    case 'crown-collector':
      ...
      return {
        progressText: t('achievements.progressHints.crown_collector.progress', { current: crownCollector, target: 5 }),
        progressPercentage: (crownCollector / 5) * 100,
        isCompleted: crownCollector >= 5,
        requirementText: t('achievements.progressHints.crown_collector.requirement'),
        actionHint: t('achievements.progressHints.crown_collector.action'),
    ...
    case 'crown-master':
      ...
      return {
        progressText: t('achievements.progressHints.crown_master.progress', { current: crownMaster, target: 10 }),
        progressPercentage: (crownMaster / 10) * 100,
        isCompleted: crownMaster >= 10,
        requirementText: t('achievements.progressHints.crown_master.requirement'),
        actionHint: t('achievements.progressHints.crown_master.action'),
    ...
    case 'crown-champion':
      ...
      return {
        progressText: t('achievements.progressHints.crown_champion.progress', { current: crownChampion, target: 25 }),
        progressPercentage: (crownChampion / 25) * 100,
        isCompleted: crownChampion >= 25,
        requirementText: t('achievements.progressHints.crown_champion.requirement'),
        actionHint: t('achievements.progressHints.crown_champion.action'),
    ...
    case 'crown-emperor':
      ...
      return {
        progressText: t('achievements.progressHints.crown_emperor.progress', { current: crownEmperor, target: 50 }),
        progressPercentage: (crownEmperor / 50) * 100,
        isCompleted: crownEmperor >= 50,
        requirementText: t('achievements.progressHints.crown_emperor.requirement'),
        actionHint: t('achievements.progressHints.crown_emperor.action'),
    ...
    case 'deep-thinker':
      ...
      return {
        progressText: deepThinkingData.hasDeepEntry
          ? t('achievements.progressHints.deep_thinker.progress_complete', { count: deepThinkingData.totalLongEntries })
          : t('achievements.progressHints.deep_thinker.progress_incomplete', { longest: deepThinkingData.longestEntry }),
        ...
        actionHint: deepThinkingData.hasDeepEntry
          ? t('achievements.progressHints.deep_thinker.action_complete')
          : t('achievements.progressHints.deep_thinker.action_incomplete', { needed: Math.max(0, 200 - deepThinkingData.longestEntry) })
      };
...
const generateGoalProgressHint = (achievement: Achievement, userStats: UserStats, t: TFunction): ProgressHint => {
  switch (achievement.id) {
    case 'first-goal':
      return {
        progressText: userStats.goalsCreated === 0
          ? t('achievements.progressHints.first_goal.progress_incomplete')
          : t('achievements.progressHints.first_goal.progress_complete'),
        progressPercentage: userStats.goalsCreated > 0 ? 100 : 0,
        isCompleted: userStats.goalsCreated > 0,
        requirementText: t('achievements.progressHints.first_goal.requirement'),
        actionHint: t('achievements.progressHints.first_goal.action')
      };

    case 'goal-getter':
      return {
        progressText: userStats.completedGoals === 0
          ? t('achievements.progressHints.goal_getter.progress_incomplete')
          : t('achievements.progressHints.goal_getter.progress_complete'),
        progressPercentage: userStats.completedGoals > 0 ? 100 : 0,
        isCompleted: userStats.completedGoals > 0,
        requirementText: t('achievements.progressHints.goal_getter.requirement'),
        actionHint: t('achievements.progressHints.goal_getter.action')
      };

    case 'goal-achiever':
      const completed3 = Math.min(userStats.completedGoals, 3);
      return {
        progressText: t('achievements.progressHints.goal_achiever.progress', { current: completed3, target: 3 }),
        progressPercentage: (completed3 / 3) * 100,
        isCompleted: completed3 >= 3,
        requirementText: t('achievements.progressHints.goal_achiever.requirement'),
        actionHint: t('achievements.progressHints.goal_achiever.action'),
    ...
    case 'goal-champion':
      ...
      return {
        progressText: t('achievements.progressHints.goal_champion.progress', { current: completed5, target: 5 }),
        progressPercentage: (completed5 / 5) * 100,
        isCompleted: completed5 >= 5,
        requirementText: t('achievements.progressHints.goal_champion.requirement'),
        actionHint: t('achievements.progressHints.goal_champion.action'),
    ...
    case 'achievement-unlocked':
      ...
      return {
        progressText: t('achievements.progressHints.achievement_unlocked.progress', { current: completed10, target: 10 }),
        progressPercentage: (completed10 / 10) * 100,
        isCompleted: completed10 >= 10,
        requirementText: t('achievements.progressHints.achievement_unlocked.requirement'),
        actionHint: t('achievements.progressHints.achievement_unlocked.action'),
    ...
    case 'ambitious':
      return {
        progressText: userStats.hasLargeGoal
          ? t('achievements.progressHints.ambitious.progress_complete')
          : t('achievements.progressHints.ambitious.progress_incomplete'),
        progressPercentage: userStats.hasLargeGoal ? 100 : 0,
        isCompleted: userStats.hasLargeGoal,
        requirementText: t('achievements.progressHints.ambitious.requirement'),
        actionHint: t('achievements.progressHints.ambitious.action')
      };

    case 'progress-tracker':
      const progressStreak = Math.min(userStats.goalProgressStreak, 7);
      return {
        progressText: t('achievements.progressHints.progress_tracker.progress', { current: progressStreak, target: 7 }),
        progressPercentage: (progressStreak / 7) * 100,
        isCompleted: progressStreak >= 7,
        requirementText: t('achievements.progressHints.progress_tracker.requirement'),
        actionHint: t('achievements.progressHints.progress_tracker.action'),
...
const generateConsistencyProgressHint = (achievement: Achievement, userStats: UserStats, t: TFunction): ProgressHint => {
  switch (achievement.id) {
    case 'weekly-warrior':
      ...
      return {
        progressText: t('achievements.progressHints.weekly_warrior.progress', { current: userStats.longestHabitStreak }),
        progressPercentage: (weekStreak / 7) * 100,
        isCompleted: userStats.longestHabitStreak >= 7,
        requirementText: t('achievements.progressHints.weekly_warrior.requirement'),
        actionHint: t('achievements.progressHints.weekly_warrior.action')
      };

    case 'monthly-master':
      const monthStreak = Math.min(userStats.longestHabitStreak, 30);
      return {
        progressText: t('achievements.progressHints.monthly_master.progress', { current: userStats.longestHabitStreak }),
        progressPercentage: (monthStreak / 30) * 100,
        isCompleted: userStats.longestHabitStreak >= 30,
        requirementText: t('achievements.progressHints.monthly_master.requirement'),
        actionHint: t('achievements.progressHints.monthly_master.action')
      };

    case 'hundred-days':
      const centStreak = Math.min(userStats.longestHabitStreak, 100);
      return {
        progressText: t('achievements.progressHints.hundred_days.progress', { current: userStats.longestHabitStreak }),
        progressPercentage: (centStreak / 100) * 100,
        isCompleted: userStats.longestHabitStreak >= 100,
        requirementText: t('achievements.progressHints.hundred_days.requirement'),
        actionHint: t('achievements.progressHints.hundred_days.action')
      };

    case 'daily-visitor':
      const appStreak = Math.min(userStats.appUsageStreak, 7);
      return {
        progressText: t('achievements.progressHints.daily_visitor.progress', { current: appStreak, target: 7 }),
        progressPercentage: (appStreak / 7) * 100,
        isCompleted: appStreak >= 7,
        requirementText: t('achievements.progressHints.daily_visitor.requirement'),
        actionHint: t('achievements.progressHints.daily_visitor.action')
      };

    case 'dedicated-user':
      const appStreak30 = Math.min(userStats.appUsageStreak, 30);
      return {
        progressText: t('achievements.progressHints.dedicated_user.progress', { current: appStreak30, target: 30 }),
        progressPercentage: (appStreak30 / 30) * 100,
        isCompleted: appStreak30 >= 30,
        requirementText: t('achievements.progressHints.dedicated_user.requirement'),
        actionHint: t('achievements.progressHints.dedicated_user.action')
      };

    case 'perfect-month':
      const perfectDays = Math.min(userStats.perfectMonthDays, 28);
      return {
        progressText: t('achievements.progressHints.perfect_month.progress', { current: perfectDays, target: 28 }),
        progressPercentage: (perfectDays / 28) * 100,
        isCompleted: perfectDays >= 28,
        requirementText: t('achievements.progressHints.perfect_month.requirement'),
        actionHint: t('achievements.progressHints.perfect_month.action')
      };
...
const generateMasteryProgressHint = (achievement: Achievement, userStats: UserStats, t: TFunction): ProgressHint => {
  switch (achievement.id) {
    case 'level-up':
      ...
      return {
        progressText: t('achievements.progressHints.level_up.progress', { current: userStats.currentLevel }),
        progressPercentage: (level10 / 10) * 100,
        isCompleted: userStats.currentLevel >= 10,
        requirementText: t('achievements.progressHints.level_up.requirement'),
        actionHint: t('achievements.progressHints.level_up.action')
      };
    ...
    case 'balance-master':
      ...
      return {
        progressText: t('achievements.progressHints.balance_master.progress', { current: comboDays, target: 10 }),
        progressPercentage: (comboDays / 10) * 100,
        isCompleted: comboDays >= 10,
        requirementText: t('achievements.progressHints.balance_master.requirement'),
        actionHint: t('achievements.progressHints.balance_master.action'),
...
const generateSpecialProgressHint = (achievement: Achievement, userStats: UserStats, t: TFunction): ProgressHint => {
  switch (achievement.id) {
    case 'lightning-start':
      ...
      return {
        progressText: t('achievements.progressHints.lightning_start.progress', { current: sameDay, target: 3 }),
        progressPercentage: (sameDay / 3) * 100,
        isCompleted: sameDay >= 3,
        requirementText: t('achievements.progressHints.lightning_start.requirement'),
        actionHint: t('achievements.progressHints.lightning_start.action'),
    ...
    case 'persistence-pays':
      ...
      return {
        progressText: t('achievements.progressHints.persistence_pays.progress', { current: comeback, target: 7 }),
        progressPercentage: (comeback / 7) * 100,
        isCompleted: comeback >= 7,
        requirementText: t('achievements.progressHints.persistence_pays.requirement'),
        actionHint: t('achievements.progressHints.persistence_pays.action')
      };
    ...
    case 'legendary-master':
      ...
      return {
        progressText: t('achievements.progressHints.legendary_master.progress', {
          goals: goals,
          goalsTarget: 10,
          habits: habits,
          habitsTarget: 500,
        ...
        requirementText: t('achievements.progressHints.legendary_master.requirement'),
        actionHint: t('achievements.progressHints.legendary_master.action')
      };
    ...
    case 'loyalty-first-week':
      ...
      return {
        progressText: t('achievements.progressHints.loyalty_first_week.progress', { current: userStats.totalActiveDays, target: 7 }),
        progressPercentage: (days7 / 7) * 100,
        isCompleted: userStats.totalActiveDays >= 7,
        requirementText: t('achievements.progressHints.loyalty_first_week.requirement'),
        actionHint: t('achievements.progressHints.loyalty_first_week.action'),
    ...
    case 'loyalty-two-weeks-strong':
      ...
      return {
        progressText: t('achievements.progressHints.loyalty_two_weeks_strong.progress', { current: userStats.totalActiveDays, target: 14 }),
        progressPercentage: (days14 / 14) * 100,
        isCompleted: userStats.totalActiveDays >= 14,
        requirementText: t('achievements.progressHints.loyalty_two_weeks_strong.requirement'),
        actionHint: t('achievements.progressHints.loyalty_two_weeks_strong.action'),
    ...
    case 'loyalty-three-weeks-committed':
      ...
      return {
        progressText: t('achievements.progressHints.loyalty_three_weeks_committed.progress', { current: userStats.totalActiveDays, target: 21 }),
        progressPercentage: (days21 / 21) * 100,
        isCompleted: userStats.totalActiveDays >= 21,
        requirementText: t('achievements.progressHints.loyalty_three_weeks_committed.requirement'),
        actionHint: t('achievements.progressHints.loyalty_three_weeks_committed.action'),
    ...
    case 'loyalty-month-explorer':
      ...
      return {
        progressText: t('achievements.progressHints.loyalty_month_explorer.progress', { current: userStats.totalActiveDays, target: 30 }),
        progressPercentage: (days30 / 30) * 100,
        isCompleted: userStats.totalActiveDays >= 30,
        requirementText: t('achievements.progressHints.loyalty_month_explorer.requirement'),
        actionHint: t('achievements.progressHints.loyalty_month_explorer.action'),
    ...
    case 'loyalty-two-month-veteran':
      ...
      return {
        progressText: t('achievements.progressHints.loyalty_two_month_veteran.progress', { current: userStats.totalActiveDays, target: 60 }),
        progressPercentage: (days60 / 60) * 100,
        isCompleted: userStats.totalActiveDays >= 60,
        requirementText: t('achievements.progressHints.loyalty_two_month_veteran.requirement'),
        actionHint: t('achievements.progressHints.loyalty_two_month_veteran.action'),
    ...
    case 'loyalty-century-user':
      ...
      return {
        progressText: t('achievements.progressHints.loyalty_century_user.progress', { current: userStats.totalActiveDays, target: 100 }),
        progressPercentage: (days100 / 100) * 100,
        isCompleted: userStats.totalActiveDays >= 100,
        requirementText: t('achievements.progressHints.loyalty_century_user.requirement'),
        actionHint: t('achievements.progressHints.loyalty_century_user.action'),
    ...
    case 'loyalty-half-year-hero':
      ...
      return {
        progressText: t('achievements.progressHints.loyalty_half_year_hero.progress', { current: userStats.totalActiveDays, target: 183 }),
        progressPercentage: (days183 / 183) * 100,
        isCompleted: userStats.totalActiveDays >= 183,
        requirementText: t('achievements.progressHints.loyalty_half_year_hero.requirement'),
        actionHint: t('achievements.progressHints.loyalty_half_year_hero.action'),
    ...
    case 'loyalty-year-legend':
      ...
      return {
        progressText: t('achievements.progressHints.loyalty_year_legend.progress', { current: userStats.totalActiveDays, target: 365 }),
        progressPercentage: (days365 / 365) * 100,
        isCompleted: userStats.totalActiveDays >= 365,
        requirementText: t('achievements.progressHints.loyalty_year_legend.requirement'),
        actionHint: t('achievements.progressHints.loyalty_year_legend.action'),
    ...
    case 'loyalty-ultimate-veteran':
      ...
      return {
        progressText: t('achievements.progressHints.loyalty_ultimate_veteran.progress', { current: userStats.totalActiveDays, target: 500 }),
        progressPercentage: (days500 / 500) * 100,
        isCompleted: userStats.totalActiveDays >= 500,
        requirementText: t('achievements.progressHints.loyalty_ultimate_veteran.requirement'),
        actionHint: t('achievements.progressHints.loyalty_ultimate_veteran.action'),
    ...
    case 'loyalty-master':
      ...
      return {
        progressText: t('achievements.progressHints.loyalty_master.progress', { current: userStats.totalActiveDays, target: 1000 }),
        progressPercentage: (days1000 / 1000) * 100,
        isCompleted: userStats.totalActiveDays >= 1000,
        requirementText: t('achievements.progressHints.loyalty_master.requirement'),
        actionHint: t('achievements.progressHints.loyalty_master.action'),
 ...
 */
const formatCompletionDate = (unlockedAt: Date | undefined, t: TFunction): string => {
  if (!unlockedAt) {
    return t('achievements.preview.recentlyUnlocked');
  }
  ...
  if (diffDays >= 30) {
    return unlock.toLocaleDateString(t('common.locale') || 'en-US', {
      month: 'short',
      day: 'numeric',
      year: unlock.getFullYear() !== now.getFullYear() ? 'numeric' : undefined
    });
  } else if (diffDays >= 1) {
    return t('achievements.preview.daysAgo', { count: diffDays });
  } else if (diffHours >= 1) {
    return t('achievements.preview.hoursAgo', { count: diffHours });
  } else if (diffMinutes >= 1) {
    return t('achievements.preview.minutesAgo', { count: diffMinutes });
  } else {
    return t('achievements.preview.justNow');
  }
};
 ...
 */
const calculateTimeToComplete = (achievement: Achievement, userStats: UserStats, t: TFunction): string => {
  if (!achievement.unlockedAt) {
    return t('achievements.preview.achievedThroughDedication');
  }
  ...
  if (estimatedDays < 14) {
    return t('achievements.preview.achievedInDays', { count: estimatedDays });
  } else if (estimatedDays < 60) {
    const weeks = Math.round(estimatedDays / 7);
    return t('achievements.preview.achievedInWeeks', { count: weeks });
  } else {
    const months = Math.round(estimatedDays / 30);
    return t('achievements.preview.achievedInMonths', { count: months });
  }
};
...
export const generateCompletionInfo = (achievement: Achievement, userStats: UserStats, t: TFunction): CompletionInfo => {
  ...
  const category = getCategoryDisplayName(achievement.category, t);
  const difficulty = getDifficultyLevel(achievement.rarity, t);

  return {
    accomplishment,
    completionDate: formatCompletionDate(achievement.unlockedAt, t),
    timeToComplete: calculateTimeToComplete(achievement, userStats, t),
    category,
...
const getCategoryDisplayName = (category: AchievementCategory, t: TFunction): string => {
  const categoryKeys: Record<AchievementCategory, string> = {
    [AchievementCategory.HABITS]: 'achievements.categories.habits',
    [AchievementCategory.JOURNAL]: 'achievements.categories.journal',
    [AchievementCategory.GOALS]: 'achievements.categories.goals',
    [AchievementCategory.CONSISTENCY]: 'achievements.categories.consistency',
    [AchievementCategory.MASTERY]: 'achievements.categories.mastery',
    [AchievementCategory.SPECIAL]: 'achievements.categories.special',
  };
  return t(categoryKeys[category] || 'achievements.categories.all');
};

const getDifficultyLevel = (rarity: AchievementRarity, t: TFunction): string => {
  const difficultyKeys: Record<AchievementRarity, string> = {
    [AchievementRarity.COMMON]: 'achievements.preview.difficultyEasy',
    [AchievementRarity.RARE]: 'achievements.preview.difficultyMedium',
    [AchievementRarity.EPIC]: 'achievements.preview.difficultyHard',
    [AchievementRarity.LEGENDARY]: 'achievements.preview.difficultyLegendary'
  };
  return t(difficultyKeys[rarity] || 'achievements.preview.difficultyUnknown');
};
...
export const generateSmartTooltip = (achievement: Achievement, progress: number, t: TFunction): SmartTooltip => {
  const progressLevel = getProgressLevel(progress);

  return {
    primaryTip: getPrimaryTip(achievement, progressLevel, t),
    motivationalMessage: getMotivationalMessage(progressLevel, t),
    actionAdvice: getActionAdvice(achievement, progressLevel, t),
    estimatedEffort: getEffortEstimate(achievement, progress, t)
  };
};
...
const getPrimaryTip = (achievement: Achievement, level: 'starting' | 'building' | 'advancing' | 'nearly_there', t: TFunction): string => {
  const categoryKey = achievement.category.toLowerCase();
  return t(`achievements.preview.tips.${categoryKey}.${level}`);
};

const getMotivationalMessage = (level: 'starting' | 'building' | 'advancing' | 'nearly_there', t: TFunction): string => {
  return t(`achievements.preview.motivation.${level}`);
};

const getActionAdvice = (achievement: Achievement, level: 'starting' | 'building' | 'advancing' | 'nearly_there', t: TFunction): string => {
  const categoryKey = achievement.category.toLowerCase();
  return t(`achievements.preview.advice.${categoryKey}`);
};

const getEffortEstimate = (achievement: Achievement, progress: number, t: TFunction): string | undefined => {
  if (progress >= 90) return t('achievements.preview.effort.almostThere');
  if (progress >= 70) return t('achievements.preview.effort.fewMoreDays');
  if (progress >= 40) return t('achievements.preview.effort.oneToTwoWeeks');
  if (progress >= 20) return t('achievements.preview.effort.twoToFourWeeks');
  return t('achievements.preview.effort.severalWeeks');
};
...
const getDefaultProgressHint = (achievement: Achievement, t: TFunction): ProgressHint => {
  return {
    progressText: t('achievements.progressHints.default.progress'),
    progressPercentage: 0,
    isCompleted: false,
    requirementText: achievement.descriptionKey, // Translation key - will be translated at component level
    actionHint: t('achievements.progressHints.default.action')
  };
};